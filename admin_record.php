...
<div style="text-align:center;">
    ...
    <div class="d-flex flex-row flex-shrink-0">
        ...
        <div class="sidebar-column">
            <ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
                <li class="border-3 border-primary rounded-3">
                    <a href="proindexaddmin_record.php" class="nav-link py-3 border-bottom rounded-0">
                ...
                <li class="border-3 border-primary rounded-3">
                    <a href="users_record.php" class="nav-link py-3 border-bottom rounded-0">
        ...
        $(document).ready(function() {
            ...
            $('.main-column').load('proindexaddmin_record.php');

            // When clicking on the "คำร้องขอโครงการ" link
            $('a[href="proindexaddmin_record.php"]').click(function(e) {
                e.preventDefault();
                $('.main-column').load('proindexaddmin_record.php');
            });
 
            // When clicking on the "คำร้องขออนุญาตไปราชการและขอใช้รถราชการ" link
            $('a[href="users_record.php"]').click(function(e) {
                e.preventDefault();
                $('.main-column').load('users_record.php');
            });
        });
